from main_functions import union, intersection, difference, sis_difference, digits_addition,digits_count, digits_analize, delete_set
...
while option == None or OPTIONS[option]["key"] != 0:
  ...
  if OPTIONS[option]["key"] == 1:
    number_of_sets = insert_set(sets, number_of_sets)
